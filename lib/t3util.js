...
module.exports.needsMapRefresh = function (map) {
    if (!map || !map.hasOwnProperty('refreshTime') || typeof map.refreshTime !== 'Date')
        return true;
    return (new Date() - map.refreshTime) > (1000 * 3600 * 24);  // more than 1 day
}
